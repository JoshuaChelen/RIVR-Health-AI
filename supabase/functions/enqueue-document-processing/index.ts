...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Optional: prevent duplicate queued/running jobs for the same docs
    // This is best-effort, not perfect, but it reduces spam.
    ...
    // Insert job (IMPORTANT: keep job_type consistent with your worker)
    ...
    // Mark docs as processing (so UI and worker agree)
